...
中期朝鮮語においては -t 幹名詞と -s 幹名詞は対立していたが、後に中和した。この際、現代語の音声としては両方が ⫽ㄷ⫽ コーダとなったが、曲用のパラダイムとしては圧倒的多数であった -s 幹に元来 ㄷ で終わっていた名詞が全て吸収される形となったため、現代の文化語においては ㄷ 幹名詞のパラダイムは存在しない。
...
要するに、《히읗》というのは、文字名を「[子音]ㅣ으[子音]」の形に統一しようとしたことによりいわば人工的に生み出した語形であるが、しかしそのような人工的な語のためだけに格変化のパラダイムを新たに増やして「h 幹名詞」なるものを生み出すわけにはいかず、最も無標な閉鎖音幹である s 幹名詞のパラダイムに吸収されているのである。

:>:


<b>後続する子音を激音にするというマーカー</b>としてしか用いられていない。
