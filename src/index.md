...
- -ŋ 幹名詞： 〈[열정] - [열정에]〉「熱情」など多数<ul><li>文字の上ではオンセットに来る /ŋ/ を表記できないのでコーダとして綴るが、歌唱上での発声タイミングなどを鑑みるに、他と同様に音声上はオンセットに来ていると見なすべきであると hsjoihs は考える。</li></ul>
...
しかし、文化語ではこれらの語は [트] で終わる母音語幹として借用されているため、-s 幹名詞が文化語においても本当に open class であるとは直ちには言い難い。ただ、文字名の挙動（後述）から見るに、まだ open class であるといっても差し支えないであろう。
